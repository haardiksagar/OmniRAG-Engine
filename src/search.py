...
class RAGSearch:
    ...
    def search_and_summarize(self, query: str, top_k: int = 5) -> str:
        ...
        prompt = f"""Provide a detailed, expanded summary (around 200-350 words) for the query: '{query}'.\n\nPlease include key points, brief examples, implications, and any relevant definitions. If the context is limited, still give an in-depth explanation based on the available information.\n\nContext:\n{context}\n\nDetailed Summary:"""
